...
export function Testimonial({
  ...
  return (
    <div className="relative flex flex-col gap-4 pb-2 pl-5 pt-1 before:absolute before:bottom-0 before:left-0 before:top-0 before:w-[3px] before:rounded-full before:bg-gray-200 dark:before:bg-gray-700">
